...
Característica: Obtener cotización para clientes hombres solteros.
  ...
  @hombres_solteros
  Escenario: Hombre soltero de Guayaquil de 19 años con infarto
  ...
  Escenario: Hombre soltero de Cuenca de 90 años con diabetes
  ...
  Escenario: Hombre soltero de Manta de 50 años con diabetes
  ...
  Escenario: Hombre soltero de Machala de 50 años sin precedentes
  ...
  Escenario: Hombre soltero de Machala de 70 años con osteoporosis
