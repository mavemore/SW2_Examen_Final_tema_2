...
@given("que un {sexo} tiene {edad} años ademas tiene {dependientes} dependientes ademas es de {ciudad} ademas es {estado_civil} ademas tiene {especial} condicion especial")
...
def step_impl(context):
	valor = cotizar_seguro(context.ciudad, context.edad, context.sexo, context.estado_civil, context.especial, context.dependientes)
	context.valor = valor
